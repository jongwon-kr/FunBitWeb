...
//    @Transactional
//    public List<Trend> getTrends() throws MalformedURLException {
//
//        DesiredCapabilities capabilities = new DesiredCapabilities();
//        capabilities.setBrowserName("chrome");
//        WebDriver driver = new RemoteWebDriver(new URL(" http://chrome:4444/wd/hub"), capabilities);
...
//    }
    ...
    @Transactional
    public List<Trend> getTrends() throws RuntimeException, MalformedURLException {
        DesiredCapabilities capabilities = new DesiredCapabilities();
        capabilities.setBrowserName("chrome");
